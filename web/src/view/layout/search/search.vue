  ...
  <div class="search-component">
    ...
    <template v-else>
      <div
        class="user-box"
      >
        <div class="opmIcon opmIcon-refresh" :class="[reload ? 'reloading' : '']" @click="handleReload" />
      </div>
      <div
        class="user-box"
      >
        <div class="opmIcon opmIcon-search" @click="showSearch" />
      </div>
      <div
        class="user-box"
      >
      ...
      <div
        class="user-box"
      >
        <div class="service opmIcon-customer-service" @click="toService" />
      </div>
    </template>
  </div>
</template>
...
.service {
  font-family: "opmIcon",serif !important;
    font-size: 16px;
    font-style: normal;
    font-weight: 800;
