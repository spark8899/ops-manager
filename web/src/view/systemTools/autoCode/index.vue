<template>
  <div>
    ...
    <div class="opm-search-box">
      ...
      <el-form ref="autoCodeForm" :rules="rules" :model="form" label-width="120px" :inline="true">
        ...
        <el-form-item label="业务库" prop="businessDB">
          <template #label>
            <el-tooltip content="注：需要提前到db-list自行配置多数据库，此项为空则会使用opm本库创建自动化代码(global.OPM_DB),填写后则会创建指定库的代码(global.MustGetGlobalDBByDBName(dbname))" placement="bottom" effect="light">
              <div> 业务库 <el-icon><QuestionFilled /></el-icon> </div>
            </el-tooltip>
          </template>
          <el-select
    ...
    <!-- 组件列表 -->
    <div class="opm-table-box">
      <div class="opm-btn-list">
      ...
      <!-- 组件列表 -->
      <div class="opm-btn-list justify-content-flex-end auto-btn-list">
