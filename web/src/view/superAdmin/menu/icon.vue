<template>
  <div>
    <span class="opm-icon" style="position: absolute; z-index: 9999; padding: 3px 10px 0; ">
      <el-icon>
        <component :is="metaData.icon" />
      </el-icon>
    </span>
    <el-select v-model="metaData.icon" style="width:100%" clearable filterable class="opm-select" placeholder="请选择">
      <el-option
        ...
        :value="item.key"
      >
        <span class="opm-icon" style=" padding: 3px 0 0; " :class="item.label">
          <el-icon>
