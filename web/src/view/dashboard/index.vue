<template>
  <div class="page">
    <div class="opm-card-box">
      <div class="opm-card opm-top-card">
        <div class="opm-top-card-left">
          <div class="opm-top-card-left-title">早安，管理员，请开始一天的工作吧</div>
          <div class="opm-top-card-left-dot">{{ weatherInfo }}</div>
          <div class="opm-top-card-left-rows">
            <el-row>
    ...
    <div class="opm-card-box">
      <el-card class="opm-card quick-entrance">
        <template #header>
